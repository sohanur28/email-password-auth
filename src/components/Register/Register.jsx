...
const Register = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if(!/(?=.*[A-Z])/.test(password)){
            setError('Please add at least one Uppercae');
            return;
        }
    ...
    return (
        <div className='w-50 mx-auto'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <input className='w-50 mb-4 rounded p-2' onBlur={handlePasswordBlur} type="password" name="password" id="password" placeholder='Your Password' required />
                <br />
